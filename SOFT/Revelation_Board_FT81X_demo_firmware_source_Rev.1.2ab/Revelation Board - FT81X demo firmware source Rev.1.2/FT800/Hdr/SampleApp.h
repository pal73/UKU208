...
extern SAMAPP_Bitmap_header_t  SAMAPP_Bitmap_RawData_Header2[];

extern const FT_PROGMEM ft_prog_uchar8_t SAMAPP_Bitmap_RawData[];
extern const FT_PROGMEM ft_prog_uchar8_t SAMAPP_Bitmap_RawData2[];
extern const FT_PROGMEM ft_prog_uchar8_t galva[];
