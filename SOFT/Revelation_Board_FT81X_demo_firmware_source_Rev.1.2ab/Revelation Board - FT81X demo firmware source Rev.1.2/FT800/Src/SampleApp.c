...
#endif
#if defined(ARDUINO_PLATFORM) || defined(STM32F4XX)
...
ft_void_t SAMAPP_CoPro_Sketch()
{
	...
	Ft_Gpu_CoCmd_Sketch(phost, BorderSz2,BorderSz,(FT_DispWidth - 2*BorderSz2),(FT_DispHeight - BorderSz - BorderSz2),0,L1);//sketch in L1 format
	/* Display the sketch */
	Ft_Gpu_CoCmd_Dlstart(phost);
	Ft_App_WrCoCmd_Buffer(phost,CLEAR_COLOR_RGB(0xff,0,0x00));
	Ft_App_WrCoCmd_Buffer(phost,CLEAR(1,1,1));
	Ft_App_WrCoCmd_Buffer(phost,COLOR_RGB(0xff,0xff,0xff));
	...
	Ft_App_WrCoCmd_Buffer(phost,BEGIN(BITMAPS));
	Ft_App_WrCoCmd_Buffer(phost,BITMAP_SOURCE(0));
	Ft_App_WrCoCmd_Buffer(phost,BITMAP_LAYOUT(L1,(FT_DispWidth - 2*BorderSz2)/8,(FT_DispHeight  - BorderSz - BorderSz2)));
	...
	Ft_Gpu_Hal_Sleep(3000*1000);//sleep for 10 seconds
	...
	Ft_Gpu_CoCmd_MemZero(phost, RAM_G,MemZeroSz);
	Ft_Gpu_CoCmd_Sketch(phost, BorderSz,BorderSz,(FT_DispWidth - 2*BorderSz2),(FT_DispHeight - BorderSz - BorderSz2),0,L8);//sketch in L8 format
	/* Display the sketch */
	Ft_Gpu_CoCmd_Dlstart(phost);
	Ft_App_WrCoCmd_Buffer(phost,CLEAR_COLOR_RGB(0,0,0xff));
	Ft_App_WrCoCmd_Buffer(phost,CLEAR(1,1,1));
	Ft_App_WrCoCmd_Buffer(phost,COLOR_RGB(0xff,0xff,0xff));
	Ft_App_WrCoCmd_Buffer(phost,SCISSOR_SIZE(FT_DispWidth,(FT_DispHeight - BorderSz)));
	Ft_App_WrCoCmd_Buffer(phost,SCISSOR_XY(0,BorderSz));
	...
	Ft_Gpu_Hal_Sleep(3000*1000);//sleep for 3 seconds
